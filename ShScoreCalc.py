...
# Drop data columns not relevant to severity in terms of climate
Hurricane_nyc = Hurricane_nyc.drop(labels=["Fatalities", "Economic_Loss(USD million estimated)", "Total_Duration(estimated_hours)", "Name"], axis=1)
